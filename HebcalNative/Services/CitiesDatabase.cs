...
namespace ItimHebrewCalendar.Services
{
    public static class CitiesDatabase
    {
        public static readonly List<LocationInfo> Cities = new()
        {
            ...
            new() { Name = "בני ברק", NameEn = "Bnei Brak", Latitude = 32.0809, Longitude = 34.8338, Elevation = 30, TimeZone = "Asia/Jerusalem", IsInIsrael = true, CandleLightingMinutes = 22 },
            ...
            new() { Name = "צפת", NameEn = "Safed", Latitude = 32.9650, Longitude = 35.4967, Elevation = 936, TimeZone = "Asia/Jerusalem", IsInIsrael = true, CandleLightingMinutes = 30 },
            ...
            new() { Name = "בית שמש", NameEn = "Beit Shemesh", Latitude = 31.7488, Longitude = 34.9887, Elevation = 300, TimeZone = "Asia/Jerusalem", IsInIsrael = true, CandleLightingMinutes = 40 },
            ...
            new() { Name = "ערד", NameEn = "Arad", Latitude = 31.2589, Longitude = 35.2128, Elevation = 640, TimeZone = "Asia/Jerusalem", IsInIsrael = true, CandleLightingMinutes = 22 },
            ...
            new() { Name = "אלעד", NameEn = "Elad", Latitude = 32.0522, Longitude = 34.9519, Elevation = 100, TimeZone = "Asia/Jerusalem", IsInIsrael = true, CandleLightingMinutes = 30 },
            new() { Name = "עמנואל", NameEn = "Emmanuel", Latitude = 32.1611, Longitude = 35.1344, Elevation = 450, TimeZone = "Asia/Jerusalem", IsInIsrael = true, CandleLightingMinutes = 40 },
            new() { Name = "רכסים", NameEn = "Rekhasim", Latitude = 32.7447, Longitude = 35.0808, Elevation = 240, TimeZone = "Asia/Jerusalem", IsInIsrael = true, CandleLightingMinutes = 30 },
            ...
            new() { Name = "קשת", NameEn = "Qeshet", Latitude = 32.979982, Longitude = 35.808555, Elevation = 702, TimeZone = "Asia/Jerusalem", IsInIsrael = true, CandleLightingMinutes = 40 },
